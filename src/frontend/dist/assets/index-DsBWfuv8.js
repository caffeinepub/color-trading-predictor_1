...
function getPrediction(selectedNum, tradeCount, hackMode) {
  if (hackMode) {
    ...
    const profit2 = Number.parseFloat((5 + Math.random() * 4.9).toFixed(1));
    return { num1: num12, num2: num22, type: "BIG", color: "GREEN", profit: profit2, isWin: true };
  }
  ...
  if (isBig) {
    ...
    const profit2 = Number.parseFloat((2.5 + Math.random() * 4.5).toFixed(2));
    return { num1: num12, num2: num22, type: "BIG", color: "GREEN", profit: profit2, isWin: true };
  }
